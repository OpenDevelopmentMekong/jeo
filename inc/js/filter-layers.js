   ...
   if(this._layers.swapLayers && this._layers.swapLayers.length >= 2) {
    ...
    _.each(swap, function(layer) {
     ...
     if(layer.first)
      ...
      if (layer.download)
       list += '<a class="download-url" target="_blank" href="'+layer.download+'"><svg class="icon-download" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" viewBox="0 0 512 512"><g id="icomoon-ignore"></g><path d="M256 496l240-240h-144v-256h-192v256h-144z"></path></svg></a>';
