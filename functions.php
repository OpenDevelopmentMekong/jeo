...
function jeo_theme_scripts() {
 ...
 wp_register_style('font-opensans', 'https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800');
...
function jeo_flush_rewrite() {
 global $pagenow;
 if(is_admin() && in_array('activated',$_REQUEST) && $_REQUEST['activated'] && $pagenow == 'themes.php') {
  global $wp_rewrite;
  $wp_rewrite->init();
